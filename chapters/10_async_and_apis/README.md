...
<head>
    ...
    <style>
        * {
        ...
        .condition-emoji { font-size: 80px; }
        ...
        .forecast-emoji { font-size: 48px; margin: 10px 0; }
        ...
        .forecast-temp-high { font-weight: bold; color: #333; }
...
<body>
    ...
    <script>
        ...
        function updateBackgroundGradient(tempF, condition) {
            ...
            const lower = condition.toLowerCase();
            body.classList.remove('bg-sunny', 'bg-cloudy', 'bg-rainy', 'bg-cold', 'bg-hot');
            if (lower.includes('rain') || lower.includes('thunder')) body.classList.add('bg-rainy');
            else if (lower.includes('cloud')) body.classList.add('bg-cloudy');
            else if (tempF < 40) body.classList.add('bg-cold');
            else if (tempF > 85) body.classList.add('bg-hot');
            else body.classList.add('bg-sunny');
        }
